...
<div id="career-major-section" class="w-full flex flex-col space-y-10 px-6 md:px-12 lg:px-20 py-16">
    ...
    <div class="flex flex-col-reverse md:flex-row items-center gap-12">
      ...
      <div class="flex-1 text-center md:text-left" data-aos="fade-right">
        ...
        <a href="#/prediksi-karier"
           role="button"
           class="inline-block mt-4 px-6 py-3 bg-blue-600 text-white font-semibold rounded-full transition duration-300"
           style="box-shadow: 0 0 15px #2563eb, 0 0 30px #2563eb;">
          🎯 Prediksi Karier Kamu
        </a>
      </div>

      <!-- Gambar -->
      <div class="flex-1" data-aos="fade-left">
        <div class="overflow-hidden rounded-2xl transition transform hover:scale-105"
  ...
  <section aria-labelledby="major-heading"
           class="bg-gray-50 dark:bg-gray-700 py-14 text-center rounded-2xl transition-colors duration-300"
           style="box-shadow: 0 0 15px rgba(37,99,235,0.5), 0 0 30px rgba(37,99,235,0.4);">
    <header>
    ...
    <a href="#/prediksi-jurusan"
       role="button"
       class="inline-block mt-4 px-6 py-3 bg-blue-600 text-white font-semibold rounded-full transition duration-300"
       style="box-shadow: 0 0 12px #2563eb, 0 0 25px #2563eb;">
      🎓 Prediksi Jurusan Kamu
    </a>
  </section>

  <!-- Section: Navigasi dan Konten -->
  <section aria-label="Navigasi dan Hasil Rekomendasi"
           class="min-h-screen bg-gray-100 dark:bg-gray-900 py-12 rounded-2xl transition-colors duration-300"
           style="box-shadow: 0 0 15px rgba(37,99,235,0.3), 0 0 25px rgba(37,99,235,0.3);">
    ...
    <article id="content" class="space-y-14 animate-fadeIn min-h-[300px]" aria-live="polite"></article>
  </section>
    ...
    <section class="mb-20 p-6 md:p-8 rounded-2xl bg-white dark:bg-gray-800 shadow transition-colors duration-300">
      ...
      <ul class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
        ${careers
          ...
          <li class="bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-2xl p-8 shadow-sm transform transition duration-300 hover:shadow-lg hover:scale-105 cursor-pointer text-center flex flex-col items-center">
  ...
  populateMajorList(majors) {
    ...
    <ul class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4">
      ${majors
        .map(
          ({ name, description, image }) => `
        <li class="group bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-2xl p-8 shadow-sm hover:shadow-md hover:bg-blue-50 dark:hover:bg-gray-600 transition duration-300 cursor-pointer flex flex-col items-center text-center">
